  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        {/* Your exact background div - completely unchanged */}
        <div className="absolute top-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b from-cyan-100/70"></div>

        {/* left column - completely unchanged except for the null check */}
        <div className="max-w-xl z-10 text-gray-500">
          <h1 className="md:text-courses-deatails-heading-large text-courses-deatails-heading-small font-semibold text-gray-800">
          ...
          {/* review and rating - completely unchanged */}
          ...
          <p className="text-sm">
            Course by <span className="text-blue-600 underline">Edu Tech</span>
          </p>
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <img
                        className={`transform transform-transform ${
                  ...
                  >
                    <ul
                      className="list-disk md:pl-10 pr-4 text-gray-600 border-t 
                          border-gray-300"
                    >
        ...
        >
         {playerData ? (
          ...
          <div className="p-5">
            ...
            >
              ...
              <div className="flex items-center gap-1">
                ...
                <p>{calculateNoOfLecture(courseData)} lession</p>
              </div>
            </div>
          ...
          text-white font-medium"
            ...
            text-gray-500"
              >
                <li>Lifetimme access with free updated</li>
