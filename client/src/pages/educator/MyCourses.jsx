        ...
        <div className='w-full'>
              ...
              rounded-md bg-white border border-gray-500/20'>
               <table className='md:table-auto table-fixed w-full overflow-hidden'>
                ...
                <tbody className='text-sm tex-gray-500'>
                  {courses.map((course) => (
                    <tr key={course._id} className='border-b border-gray-500/20'>
                      <td className='md:px-4 pl-2 md:pl-4 py- flex items-center
                      space-x-3 truncate'>
                        <img src={course.courseThumbnail} alt="Course image" className='w-16'/>
                        <span className='curncate hidden md:block'>
                          {course.courseTitle}
                        </span>
                      </td>
                      <td className='px-4 py-3'>
                         {currency} {Math.floor(course.
