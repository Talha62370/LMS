      ...
      md:px-0 justify-center gap-10 md-gap-32 py-10 border-b border-white/30">
        <div className="flex flex-col md:items-start items-center w-full">
          ...
          <p className="mt-6 text-center md:text-left text-sm text-white/80">
            ...
            mollitia cum recusandae aspernatur quia blanditiis.
          </p>
        </div>
        <div className="flex flex-col md:items-start items-center w-full">
        ...
        <div className="hidden md:flex flex-col items-start w-full">
             ...
             <p className="text-sm text-white/80">
              The latest news, articales, and resources, sent to your inbox weekely.
             </p>
             <div className="flex items-center gap-2 pt-4">
                <input type="email" placeholder="Enter your email"
                className="border border-gray-500/30 bg-gray-800 text-gray-500
                placeholder-gary-500 outline-none w-64 h-9 text-white rounded"/>
