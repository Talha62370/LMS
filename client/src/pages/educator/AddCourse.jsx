  ...
  return (
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        ...
        {/* section for price and thumbnail */}
        <div className='flex flex-col gap-1'>
        ...
        <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
          <div className='flex justify-between items-center p-4 border-b'>
           <div className='flex items-center'>
            ...
            src={assets.dropdown_icon} width={14} alt="Dropdown_iconn" 
           ...
           src={assets.cross_icon} alt="" className='cursior-pointer'/>
          </div>
          {!chapter.collapsed && (
            <div className='p-4'>
       ...
       </div>
       {
        showPopup && (
          <div className='fixed inset-0 flex items-center justify-center
            ...
            py-2 roounded' onClick={addLecture}>
              Add
            </button>

            <img onClick={() => setShowPopup(false)} src={assets.cross_icon}
            className='absolute top-4 right-4 w-4 cursior-pointer' alt="" />
            </div>
          </div>
        )
       }
