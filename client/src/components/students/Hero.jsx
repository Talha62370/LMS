  ...
  px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70"
    >
      ...
      >
        ...
        <span className="text-blue-600">fit your choise and pace.</span>
        <img
          src={assets.sketch}
          alt="sketch"
      ...
      <p className="md:block hidden text-gray-500 max-w-2xl mx-auto">
        We bring together world-class instructors, interective content, and a
        supportive community to help you achive your learning and carrer goals.
      </p>
